...
./ccminer -a mtp -o stratum+tcp://zcoin.mintpond.com:3000 -u aFZGwPK5dAb8i4feQ5WjRjvWhFiMQn8JwZ.`hostname`_1 -i 19 -p x,d=8192,strict -R 30 -r 100 -d 2,3 > log_`hostname`.txt.1 2> err_`hostname`.txt.1 ;
